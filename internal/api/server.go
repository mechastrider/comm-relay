...
func NewHandler(opts Options) (http.Handler, error) {
	...
	mux.HandleFunc("GET /api/progression/levels", progressionHandler.handleLevels)
	mux.HandleFunc("GET /api/progression/achievements", progressionHandler.handleAchievements)
	mux.HandleFunc("GET /api/progression/settings", progressionHandler.handleSettings)
	mux.HandleFunc("GET /api/progression/status", progressionHandler.handleStatus)
	mux.HandleFunc("GET /api/progression/viewer", progressionHandler.handleViewer)
	mux.HandleFunc("POST /api/progression/levels/create", progressionHandler.handleLevelCreate)
	mux.HandleFunc("POST /api/progression/levels/update", progressionHandler.handleLevelUpdate)
	mux.HandleFunc("POST /api/progression/levels/delete", progressionHandler.handleLevelDelete)
	mux.HandleFunc("POST /api/progression/achievements/create", progressionHandler.handleAchievementCreate)
	mux.HandleFunc("POST /api/progression/achievements/update", progressionHandler.handleAchievementUpdate)
	mux.HandleFunc("POST /api/progression/achievements/delete", progressionHandler.handleAchievementDelete)
	mux.HandleFunc("POST /api/progression/settings/update", progressionHandler.handleSettingsUpdate)
	mux.HandleFunc("POST /api/progression/reconcile", progressionHandler.handleReconcile)
	mux.HandleFunc("POST /api/progression/preview", progressionHandler.handlePreview)
