...
func (c Config) Public() PublicConfig {
	return PublicConfig{
		...
		ActivityIntervalSeconds: c.ActivityIntervalSeconds,
		ActivitySessionLimit:    c.ActivitySessionLimit,
...
// ActivitySettings returns store-facing activity grant settings.
func (c Config) ActivitySettings() (intervalSeconds, sessionLimit, xp int) {
	return c.ActivityIntervalSeconds, c.ActivitySessionLimit, c.ActivityXP
}
