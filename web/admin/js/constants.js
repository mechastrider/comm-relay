...
export const STUDIO_SETUP_STATE_KEY = "commRelay.studio.obsSetupState";
export const STUDIO_MODE_KEY = "commRelay.studio.mode";
export const STUDIO_SURFACE_RAIL_COLLAPSED_KEY = "commRelay.studio.surfaceRailCollapsed";
