...
export const OVERLAY_FONT_FAMILIES = ["system", "segoe", "condensed_hud"];
export const OVERLAY_TEXT_EFFECTS = ["shadow", "outline", "none"];
export const OVERLAY_PLATFORM_MARKERS = ["stripe", "icon", "both", "none"];
