...
export const diagAdminWs = document.getElementById("diag-admin-ws");
export const diagStaleNotice = document.getElementById("diag-stale-notice");
...
export const overlayLeaderboardShowViewerTitles = document.getElementById("overlay-leaderboard-show-viewer-titles");
...
export const studioEssentialLeaderboardTitles = document.getElementById("studio-essential-leaderboard-titles");
...
export const obsRecapUrl = document.getElementById("obs-recap-url");
export const obsRecapUrlPinned = document.getElementById("obs-recap-url-pinned");
export const obsRecapPinnedLabel = document.getElementById("obs-recap-pinned-label");
export const obsRecapOpen = document.getElementById("obs-recap-open");
...
export const liveMessagesRegion = document.getElementById("live-messages-region");
export const liveMessagesLoading = document.getElementById("live-messages-loading");
export const liveMessagesError = document.getElementById("live-messages-error");
...
export const liveContractsTab = document.getElementById("live-contracts-tab");
...
export const liveContractsPanel = document.getElementById("live-contracts-panel");
...
export const discardChangesDialog = document.getElementById("discard-changes-dialog");
export const discardChangesMessage = document.getElementById("discard-changes-message");
export const discardChangesCancel = document.getElementById("discard-changes-cancel");
export const discardChangesConfirm = document.getElementById("discard-changes-confirm");
...
export const studioAddToObsRecapFollowUrl = document.getElementById("studio-add-to-obs-recap-follow-url");
export const studioAddToObsRecapPinnedUrl = document.getElementById("studio-add-to-obs-recap-pinned-url");
export const studioAddToObsRecapPinnedLabel = document.getElementById("studio-add-to-obs-recap-pinned-label");
export const studioAddToObsRecapOpen = document.getElementById("studio-add-to-obs-recap-open");
...
export const audienceInspectorError = document.getElementById("audience-inspector-error");
...
export const audienceSheetError = document.getElementById("audience-sheet-error");
...
export const audienceHistoryTab = document.getElementById("audience-history-tab");
export const audienceArchiveTab = document.getElementById("audience-archive-tab");
...
export const audienceHistoryPanel = document.getElementById("audience-history-panel");
export const audienceArchivePanel = document.getElementById("audience-archive-panel");
export const audienceArchiveContent = document.getElementById("audience-archive-content");
export const audienceArchiveBack = document.getElementById("audience-archive-back");
export const audienceArchiveDownload = document.getElementById("audience-archive-download");
export const audienceArchiveRetry = document.getElementById("audience-archive-retry");
export const audienceArchiveStatus = document.getElementById("audience-archive-status");
...
export const commandsEditorStatus = document.getElementById("commands-editor-status");
...
export const commandAliasesInput = document.getElementById("command-aliases-input");
export const commandAliasesError = document.getElementById("command-aliases-error");
...
export const awardsEditorStatus = document.getElementById("awards-editor-status");
...
export const greetingSoundInput = document.getElementById("greeting-sound");
export const greetingImagePreview = document.getElementById("greeting-image-preview");
export const greetingImageInput = document.getElementById("greeting-image-input");
export const greetingImageClear = document.getElementById("greeting-image-clear");
export const greetingImageError = document.getElementById("greeting-image-error");
export const greetingImageFitInput = document.getElementById("greeting-image-fit-input");
export const greetingImageFitError = document.getElementById("greeting-image-fit-error");
export const greetingImageSizeInput = document.getElementById("greeting-image-size-input");
export const greetingImageSizeValue = document.getElementById("greeting-image-size-value");
export const greetingImageSizeError = document.getElementById("greeting-image-size-error");
export const greetingSoundFileInput = document.getElementById("greeting-sound-file-input");
export const greetingSoundFileClear = document.getElementById("greeting-sound-file-clear");
export const greetingSoundFileError = document.getElementById("greeting-sound-file-error");
export const greetingSoundVolumeInput = document.getElementById("greeting-sound-volume-input");
export const greetingSoundVolumeValue = document.getElementById("greeting-sound-volume-value");
export const greetingSoundVolumeError = document.getElementById("greeting-sound-volume-error");
export const greetingSoundPlay = document.getElementById("greeting-sound-play");
export const greetingSoundStop = document.getElementById("greeting-sound-stop");
export const greetingLayoutError = document.getElementById("greeting-layout-error");
...
export const liveRecapButton = document.getElementById("live-recap-button");
export const liveRecapDialog = document.getElementById("live-recap-dialog");
export const liveRecapHeading = document.getElementById("live-recap-heading");
export const liveRecapClose = document.getElementById("live-recap-close");
export const liveRecapCurrentTab = document.getElementById("live-recap-current-tab");
export const liveRecapHistoryTab = document.getElementById("live-recap-history-tab");
export const liveRecapBody = document.getElementById("live-recap-body");
export const liveRecapStatus = document.getElementById("live-recap-status");
export const liveRecapBack = document.getElementById("live-recap-back");
export const liveRecapCancel = document.getElementById("live-recap-cancel");
export const liveRecapShow = document.getElementById("live-recap-show");
export const liveRecapConfirm = document.getElementById("live-recap-confirm");
export const liveRecapHide = document.getElementById("live-recap-hide");
export const liveRecapShowAll = document.getElementById("live-recap-show-all");
export const liveRecapDownload = document.getElementById("live-recap-download");
export const liveRecapRetry = document.getElementById("live-recap-retry");
