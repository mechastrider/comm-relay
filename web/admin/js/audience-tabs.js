/** @typedef {"viewers"|"archive"|"commands"|"greetings"|"awards"|"history"|"progression"} AudienceTabId */

/** @type {readonly AudienceTabId[]} */
export const AUDIENCE_TABS = Object.freeze(["viewers", "archive", "history", "progression", "commands", "greetings", "awards"]);
...
export function setAudienceTab(tab, options) {
  ...
  const panels = [
    ...
    { id: "archive", tab: document.getElementById("audience-archive-tab"), panel: document.getElementById("audience-archive-panel") },
