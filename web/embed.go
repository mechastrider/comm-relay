...
// FS contains admin/, dock/, overlay/, leaderboard/, alert/, recap/, and shared/ trees (siblings of this file).
//
//go:embed admin dock overlay leaderboard alert recap shared
var FS embed.FS
