...
- Админка и фронтенд разложены на ES-модули: общий рендер чата вынесен в `/shared/chat-render.js`, админский JS/CSS разбит на небольшие файлы (без изменения поведения UI).
