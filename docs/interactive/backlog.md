...
| <a id="int-034"></a>INT-034 | Показывать, что чат-команда принята или заморожена кулдауном | Commands / overlay | `in_progress` | `now` | Обсуждение 2026-09-16 | Active change [`command-outcome-feedback`](../../openspec/changes/command-outcome-feedback/). [Пакет 1](../research/operator-follow-up-changes.md) |
