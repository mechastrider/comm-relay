...
| <a id="int-035"></a>INT-035 | В Audience → Зрители показывать число эфиров, в которых зритель писал сообщения | Admin / Audience | `in_progress` | — | Обсуждение 2026-09-16 | Change `audience-session-count`, `spec-driven`. Метрика как Veteran. [Пакет 2](../research/operator-follow-up-changes.md) |
