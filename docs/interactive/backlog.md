...
| <a id="int-033"></a>INT-033 | В админке отдельно просматривать архив эфиров и итоги каждого стрима | Admin / sessions | `implemented` | Обсуждение 2026-09-16 | [admin-and-dock](../../openspec/specs/admin-and-dock/spec.md); архив [`admin-stream-archive`](../../openspec/changes/archive/2026-09-17-admin-stream-archive/) |
